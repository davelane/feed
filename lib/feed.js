        ...
        if(entries[i].media) {
            for(var y = 0; y < entries[i].media.length; y++) {
                ...
                if(entries[i].media[y].type)
                    entryMedia.link._attr.push({ type: entries[i].media[y].type });

                if(entries[i].media[y].title)
                    entryMedia.link._attr.push({ title: entries[i].media[y].title });

                if(entries[i].media[y].url)
                    entryMedia.link._attr.push({ href: entries[i].media[y].url });

                if(entries[i].media[y].length)
                    entryMedia.link._attr.push({ length: entries[i].media[y].length });
